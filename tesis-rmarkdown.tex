...
\renewcommand{\maketitle}{%
    ...
    \begin{center}
        %\vskip 2.75cm%
        \vfill
                        {\Large \bfseries \MakeUppercase{TESIS CON R RMARKDOWN, FALTA MOSTRAR BIBLIOGRAFIA}}\\
                                    {\Large  \bfseries \MakeUppercase{SUBTITULO OPCIONAL DE LA TESIS}}\\
                    \vskip 0.75cm%
...
Por completitud incluyo una cita en Bibtex: \autocite{bock2010stats}
...
Código R (se ejecuta sin necesidad de hacer copy paste del resultado a
un archivo tex):
